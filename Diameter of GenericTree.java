...
public class Main {
  ...
  static int diameterofgenerictree(Node node)
  {
    ...
    for(Node child: node.children)
    {
      ...
      {
        seconddch = deepestChildHeight;
        deepestChildHeight=childHeight;
      }
      else if(childHeight>seconddch)
      {
        seconddch= childHeight;
      }
    }

    if(deepestChildHeight+seconddch+2>diameter)
    {
      diameter = deepestChildHeight+seconddch+2;
    }
